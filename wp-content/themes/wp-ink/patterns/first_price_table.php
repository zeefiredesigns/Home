    ...
    <div class="wp-block-columns alignfull row" style="margin:0;padding: 0px;">
        ...
        <div class="wp-block-column is-vertically-aligned-center has-border-color has-white-background-color has-background"
            ...
            <p class="custom-white-space has-text-color has-text-align-center has-white-color has-dark-gray-background-color has-background"
                ...
                <?php echo esc_html_x('Standart', 'Sample name package', 'wp-ink'); ?>
            </p>
            <!-- /wp:paragraph -->
            ...
            <p class="custom-white-space has-text-color has-text-align-center has-white-color has-dark-gray-background-color has-background"
                ...
                <?php echo esc_html_x('150 USD', 'Sample price', 'wp-ink'); ?>
            </p>
            <!-- /wp:paragraph -->
            ...
            <p class="custom-white-space has-text-color has-text-align-center has-white-color has-dark-gray-background-color has-background"
                ...
                <?php echo esc_html_x('in month', 'Sample period', 'wp-ink'); ?>
            </p>
            <!-- /wp:paragraph -->
            ...
            <p class="custom-white-space has-text-color has-text-align-center has-black-color has-white-background-color has-background"
                ...
                <?php echo esc_html_x('3 months premium support access', 'Sample text', 'wp-ink'); ?>
            </p>
            <!-- /wp:paragraph -->
            ...
            <p class="custom-white-space has-text-color has-text-align-center has-black-color has-white-background-color has-background"
                style="padding: 0px;font-size: 20px;font-weight: normal;margin: 10px 0; line-height: 1;">
                <?php echo esc_html_x('3 months updates access', 'Sample text', 'wp-ink'); ?>
            </p>
            <!-- /wp:paragraph -->
            ...
            <p class="custom-white-space has-text-color has-text-align-center has-black-color has-white-background-color has-background"
                style="padding: 0px;font-size: 20px;font-weight: normal;margin: 10px 0; line-height: 1;">
                <?php echo esc_html_x('Unlimitted concurrent domain users', 'Sample text', 'wp-ink'); ?>
            </p>
            <!-- /wp:paragraph -->
            ...
            <p class="custom-white-space has-text-color has-text-align-center has-black-color has-white-background-color has-background"
                ...
                <?php echo esc_html_x('Free WP and theme setup', 'Sample text', 'wp-ink'); ?>
            </p>
            <!-- /wp:paragraph -->
            ...
            <div class="wp-block-buttons">
                ...
                <div
                    ...
                    <a class="wp-block-button__link has-pink-background-color has-background wp-element-button">
                        <?php echo esc_html_x('DETAILS', 'Text button', 'wp-ink'); ?>
                    </a>
                </div>
                <!-- /wp:button -->
            </div>
        ...
        <div class="wp-block-column is-vertically-aligned-center has-border-color has-white-background-color has-background"
            ...
            <p class="custom-white-space has-text-color has-text-align-center has-white-color has-dark-gray-background-color has-background"
                style="padding: 0px;font-size: 22px;font-weight: normal;margin: 0; line-height: 2;">
                <?php echo esc_html_x('Medium', 'Sample name package', 'wp-ink'); ?>
            </p>
            <!-- /wp:paragraph -->
            ...
            <p class="custom-white-space has-text-color has-text-align-center has-white-color has-dark-gray-background-color has-background"
                style="padding: 0px;font-size: 50px;font-weight: bold;margin: 0; line-height: 1;">
                <?php echo esc_html_x('300 USD', 'Sample price', 'wp-ink'); ?>
            </p>
            <!-- /wp:paragraph -->
            ...
            <p class="custom-white-space has-text-color has-text-align-center has-black-color has-white-background-color has-background"
                style="padding: 0px;font-size: 20px;font-weight: normal;margin: 10px 0; line-height: 1;">
                <?php echo esc_html_x('6 months premium support access', 'Sample text', 'wp-ink'); ?>
            </p>
            <!-- /wp:paragraph -->
            ...
            <p class="custom-white-space has-text-color has-text-align-center has-black-color has-white-background-color has-background"
                style="padding: 0px;font-size: 20px;font-weight: normal;margin: 10px 0; line-height: 1;">
                <?php echo esc_html_x('6 months updates access', 'Sample text', 'wp-ink'); ?>
            </p>
            <!-- /wp:paragraph -->
        ...
        <div class="wp-block-column is-vertically-aligned-center has-border-color has-white-background-color has-background"
            ...
            <p class="custom-white-space has-text-color has-text-align-center has-white-color has-dark-gray-background-color has-background"
                style="padding: 0px;font-size: 22px;font-weight: normal;margin: 0; line-height: 2;">
                <?php echo esc_html_x('Premium', 'Sample name package', 'wp-ink'); ?>
            </p>
            <!-- /wp:paragraph -->
            ...
            <p class="custom-white-space has-text-color has-text-align-center has-white-color has-dark-gray-background-color has-background"
                style="padding: 0px;font-size: 50px;font-weight: bold;margin: 0; line-height: 1;">
                <?php echo esc_html_x('500 USD', 'Sample price', 'wp-ink'); ?>
            </p>
            <!-- /wp:paragraph -->
            ...
            <p class="custom-white-space has-text-color has-text-align-center has-black-color has-white-background-color has-background"
                style="padding: 0px;font-size: 20px;font-weight: normal;margin: 10px 0; line-height: 1;">
                <?php echo esc_html_x('12 months premium support access', 'Sample text', 'wp-ink'); ?>
            </p>
            <!-- /wp:paragraph -->
            ...
            <p class="custom-white-space has-text-color has-text-align-center has-black-color has-white-background-color has-background"
                style="padding: 0px;font-size: 20px;font-weight: normal;margin: 10px 0; line-height: 1;">
                <?php echo esc_html_x('12 months updates access', 'Sample text', 'wp-ink'); ?>
            </p>
            <!-- /wp:paragraph -->
        ...
        <div class="wp-block-column is-vertically-aligned-center has-border-color has-white-background-color has-background"
            ...
            <p class="custom-white-space has-text-color has-text-align-center has-white-color has-dark-gray-background-color has-background"
                style="padding: 0px;font-size: 22px;font-weight: normal;margin: 0; line-height: 2;">
                <?php echo esc_html_x('Gold', 'Sample name package', 'wp-ink'); ?>
            </p>
            <!-- /wp:paragraph -->
            ...
            <p class="custom-white-space has-text-color has-text-align-center has-white-color has-dark-gray-background-color has-background"
                style="padding: 0px;font-size: 50px;font-weight: bold;margin: 0; line-height: 1;">
                <?php echo esc_html_x('1000 USD', 'Sample price', 'wp-ink'); ?>
            </p>
            <!-- /wp:paragraph -->
            ...
            <p class="custom-white-space has-text-color has-text-align-center has-black-color has-white-background-color has-background"
                style="padding: 0px;font-size: 20px;font-weight: normal;margin: 10px 0; line-height: 1;">
                <?php echo esc_html_x('2 years premium support access', 'Sample text', 'wp-ink'); ?>
            </p>
            <!-- /wp:paragraph -->
            ...
            <p class="custom-white-space has-text-color has-text-align-center has-black-color has-white-background-color has-background"
                style="padding: 0px;font-size: 20px;font-weight: normal;margin: 10px 0; line-height: 1;">
                <?php echo esc_html_x('2 years updates access', 'Sample text', 'wp-ink'); ?>
            </p>
            <!-- /wp:paragraph -->
