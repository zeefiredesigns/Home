 ...
 * @uses wp_ink_theme_header_style() to style front-end.
 * @uses wp_ink_theme_admin_header_style() to style wp-admin form.
 * @uses wp_ink_theme_admin_header_image() to add custom markup to wp-admin form.
 * @uses register_default_headers() to set up the bundled header images.
 * @since wp_ink
 * @return void
 */
function wp_ink_theme_custom_header_setup() {
	$args = array(
		...
		'wp-head-callback'       => 'wp_ink_theme_header_style',
		'admin-head-callback'    => 'wp_ink_theme_admin_header_style',
		'admin-preview-callback' => 'wp_ink_theme_admin_header_image',
	);
	...
	register_default_headers( array(
		'circle' => array(
			...
			'description'   => _x( 'Circle', 'header image description', 'wp-ink' )
		),
		'diamond' => array(
			'url'           => '%s/images/headers/diamond.png',
			'thumbnail_url' => '%s/images/headers/diamond-thumbnail.png',
			'description'   => _x( 'Diamond', 'header image description', 'wp-ink' )
		),
		'star' => array(
			'url'           => '%s/images/headers/star.png',
			'thumbnail_url' => '%s/images/headers/star-thumbnail.png',
			'description'   => _x( 'Star', 'header image description', 'wp-ink' )
		),
	) );
}
add_action( 'after_setup_theme', 'wp_ink_theme_custom_header_setup', 11 );
 ...
 * @return void
 */
function wp_ink_theme_header_style() {
	...
	?>
	<style type="text/css" id="wp_ink-header-css">
 ...
 * @return void
 */
function wp_ink_theme_admin_header_style() {
	$header_image = get_header_image();?>
	<style type="text/css" id="wp_ink-admin-header-css">
 ...
 * @return void
 */
function wp_ink_theme_admin_header_image() { ?>
