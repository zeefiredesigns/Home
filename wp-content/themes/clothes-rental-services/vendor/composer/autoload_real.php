...
class Luzuk_Clothes_Rental_Services_ComposerAutoloaderInit75f95ca3778976eb5c1bf35fe42ac3d4
{
    private static $loader;

    public static function luzuk_clothes_rental_services_loadClassLoader($class)
    {
    ...
    public static function luzuk_clothes_rental_services_getLoader()
    {
        if (null !== self::$loader) {
            return self::$loader;
        }
