...
class Luzuk_Clothes_Rental_Services_Loader {
	/**
	 * Array of loaders.
	 *
	 * @since  1.0.0
	 ...
	 * @return void
	 */
	public function luzuk_clothes_rental_services_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function luzuk_clothes_rental_services_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function luzuk_clothes_rental_services_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function luzuk_clothes_rental_services_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->luzuk_clothes_rental_services_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function luzuk_clothes_rental_services_load( $class ) {
